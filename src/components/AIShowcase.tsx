...
export function AIShowcase({ projects = defaultProjects }: AIShowcaseProps) {
  ...
  return (
    <section className="w-full py-12 md:py-20 px-4 bg-gradient-to-b from-violet-50/50 to-background">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-10 md:mb-14">
          <div className="p-4 bg-card border rounded-lg text-center">
            <div className="w-10 h-10 mx-auto mb-3 bg-indigo-100 rounded-lg flex items-center justify-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {projects.map((project) => (
            ...
            >
              ...
              <h4 className="text-lg font-bold mb-2 group-hover:text-violet-600 transition-colors">
                {project.title}
              </h4>
              ...
              <div className="flex gap-3 mt-auto">
                {project.github && (
                  <a
                    ...
                    className="flex items-center text-sm text-muted-foreground hover:text-violet-600 transition-colors"
                  >
                ...
                {project.link && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center text-sm text-violet-600 hover:underline font-medium"
                  >
