  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-zinc-50 dark:bg-zinc-900/50 flex flex-col items-center px-4">
      <div className="container px-4 md:px-6 max-w-4xl">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-center bg-background rounded-xl p-4 sm:p-6 md:p-8 shadow-sm border border-zinc-200 dark:border-zinc-800">
             {/* Left Column: Stats */}
             <div className="flex-shrink-0 flex flex-row md:flex-col items-center justify-center gap-2 md:gap-0 p-4 md:p-6 bg-zinc-100 dark:bg-zinc-800 rounded-lg w-full md:w-auto md:min-w-[160px]">
