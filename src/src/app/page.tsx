...
export default async function Home() {
  ...
  const [
    ...
    config.features.showProjects ? fetchContent("PROJECT") : Promise.resolve([]),
    config.features.showContributions
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      {config.features.showProjects && projectsData.length > 0 && (
        ...
        <section className="w-full max-w-4xl mx-auto p-6 md:p-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {latestPosts.map((post) => (
              ...
              >
                <div className="text-xs text-slate-500 dark:text-slate-300 mb-2 font-mono">
                  {post.date}
                </div>
