      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4 md:gap-8 mb-8 md:mb-12">
          <div className="flex items-center justify-center gap-3">
            <div className="p-2.5 sm:p-3 bg-zinc-100 dark:bg-zinc-800 rounded-full">
                <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
            </div>
            <div className="text-left">
                <p className="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400">Email Me</p>
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <div className="text-left">
                <p className="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400">Location</p>
