...
### Solution 1: SuspenseLoader (PREFERRED)

The `SuspenseLoader` is the preferred pattern for all new components.
...
### Solution 2: LoadingOverlay

The `LoadingOverlay` is used for legacy `useQuery` patterns.
