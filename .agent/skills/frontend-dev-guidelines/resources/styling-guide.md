...
### Decision Threshold: < 100 lines

For components with fewer than 100 lines of styles, define them inline at the top of the component.
...
For components with more than 100 lines of styles, move them to a separate `.styles.ts` file.
