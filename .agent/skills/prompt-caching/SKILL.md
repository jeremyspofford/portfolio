...
2. Know your cache-hit vs cache-miss latency trade-offs
3. Semantic similarity is your secret weapon
...
High variance makes cached responses less useful or even incorrect.

### ❌ No Cache Invalidation

Stale data in the cache leads to model hallucinations or outdated information.

### ❌ Caching Everything

Small, unique prompts don't benefit from caching and add unnecessary latency.
